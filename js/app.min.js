(() => {
        ...
        paralaxMouseInit(t) {
            t.forEach((t => {
                ...
                function h(e = window) {
                    ...
                    i += (l - i) * c / 1e3, r += (d - r) * c / 1e3, t.style.cssText = `transform: translate3D(${a*i/(o/10)}%,${n*r/(s/10)}%,0) rotate(0.02deg);`, requestAnimationFrame(e)
                }(), e ? h(e) : h()
            }))
        }
        setLogging(t) {
    ...
    let r = (t, e = !1, o = 500, s = 0) => {
        ...
        if (a) {
            ...
            if (document.documentElement.classList.contains("menu-open") && n(), "undefined" != typeof SmoothScroll)(new SmoothScroll).animateScroll(a, "", l);
            else {
    ...
    class l {
        ...
        scrollWatcherConstructor(t) {
            t.length ? (this.scrollWatcherLogging(`Прокинувся, стежу за об'єктами (${t.length})...`), function i(t) {
    ...
    async function h() {
        try {
            const t = "3BRk5VYKaCYKewQDPovBrWzHybcb7PGf6ZiusqRDpump";
    ...
    setTimeout((() => {
        ...
        }("max").init(), document.querySelectorAll('[data-watch="navigator"]').forEach((t => {
            let e;
            t.clientHeight > 2 ? (e = window.innerHeight / 2 / (t.clientHeight - 1), e > 1 && (e = 1), t.setAttribute("data-watch-threshold", e.toFixed(2))) : (e = 1, t.setAttribute("data-watch-threshold", e.toFixed(2)))
            ...
            function o(e) {
                if ("click" === e.type) {
                    ...
                    if ("navigator" === o.dataset.watch) {
                        let e;
                        if (document.querySelector("[data-goto]._navigator-active"), o.id && document.querySelector(`[data-goto="#${o.id}"]`)) e = document.querySelector(`[data-goto="#${o.id}"]`);
        ...
        function() {
            ...
            document.addEventListener("windowScroll", (function(c) {
                ...
                clearTimeout(a), i >= s ? (!t.classList.contains("_header-scroll") && t.classList.add("_header-scroll"), e && (i > n ? t.classList.contains("_header-show") && t.classList.remove("_header-show") : !t.classList.contains("_header-show") && t.classList.add("_header-show"), a = setTimeout((() => {
                    !t.classList.contains("_header-show") && t.classList.add("_header-show")
                }), o))) : (t.classList.contains("_header-scroll") && t.classList.remove("_header-scroll"), e && t.classList.contains("_header-show") && t.classList.remove("_header-show")), n = i <= 0 ? 0 : i
            }))
        }()
})();
(function(o, d, l) {
